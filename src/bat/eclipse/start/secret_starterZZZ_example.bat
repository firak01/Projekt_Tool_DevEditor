...
REM ### Das geht nur mit einem Trick, der im Gunde dieser Aufruf ist cmd /c secret_starterZZZ_example.bat - darum kann das Verzeichnis nicht einfach '.\' sein:
REM ### for /f "delims=" %%i in ('"%~dp0secret_starterZZZ_example.bat') do set %%i
...
@echo STARTE secret_starterZZZ_example.bat >&2
